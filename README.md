...
Непонятная аномалия при 3000 элементах у БПФ.
</span>
...
что в позволит произвести тесты алгоритмов с минимальным влиянием программных средств.
...
Построим зависимость и попробуем оценить примерную сложность алгоритмов. 
<span style="color:red">Непонятная аномалия при 3000 элементах у БПФ.</span>
...
|1000                   |2                                          |4.058                              |2.268                              |
|2000                   |2                                          |4.006                              |2.279                              |
|3000                   |1.5                                        |2.266                              |2.037                              |
|4000                   |1.333                                      |1.779                              |1.012                              |
|5000                   |1.25                                       |1.539                              |2.38                               |
|10000                  |2                                          |                                   |                                   |
|20000                  |2                                          |                                   |                                   |
|30000                  |1.5                                        |                                   |                                   |
|40000                  |1.333                                      |                                   |                                   |
